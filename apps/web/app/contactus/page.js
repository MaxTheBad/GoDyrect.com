...
export default function ContactPage(){
  return (
    <main className="hero">
      ...
      <style jsx>{`
        .hero{min-height:80vh;display:flex;align-items:center;justify-content:center;background: linear-gradient(rgba(0,0,0,0.28), rgba(0,0,0,0.28)), url('/bg.jpg');background-size:cover;background-position:center;color:#0f172a;padding:48px;}
