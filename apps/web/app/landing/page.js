...
export default function Landing() {
  ...
  // ensure the landing content fits the viewport; do NOT disable page scrolling globally
  useEffect(()=>{
    // no-op here — sizing is handled via CSS (.hero height and .content max-height)
    return undefined
  },[])
  ...
  return (
    <main ref={ref} className="hero">
      ...
      <style jsx>{`
        ...
        .hero{height:100vh;display:flex;align-items:center;justify-content:center;background: linear-gradient(rgba(0,0,0,0.12), rgba(0,0,0,0.12)), url('/bg.jpg');background-size:cover;background-position:center;background-attachment:fixed;color:#0f172a;padding:12px;}
        ...
        .content{background:linear-gradient(180deg, rgba(7,10,14,0.88), rgba(8,12,20,0.82));padding:20px;border-radius:12px;box-shadow:0 8px 24px rgba(7,10,14,0.28);color:#e6eef8;max-height:calc(100vh - 120px);overflow:auto}
