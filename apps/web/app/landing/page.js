  ...
  return (
    <main className="hero">
      ...
      <style jsx>{`
        ...
        .btn.outline{background:transparent;border:1px solid rgba(15,23,42,0.06);color:#071129}
        .btn.outline:hover{transform:translateY(-3px);box-shadow:0 10px 24px rgba(14,30,52,0.04)}
        .btn.ghost{background:rgba(15,23,42,0.02);color:#475569}
